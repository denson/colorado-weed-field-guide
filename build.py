...
for meta,body in PLANTS:
    ...
    discuss=f'[Discuss this plant with the guide]({url("companion/?plant="+meta["id"])}) — choose this profile as a possible match and prepare your observations for {CFG["title"]}.'
...
feed='<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0"><channel><title>'+esc(CFG['title'])+'</title><link>'+esc(url())+'</link><description>Profile and source revisions</description>'
