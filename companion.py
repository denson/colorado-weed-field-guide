...
<div class="field-bot"><img src="{base}/assets/colorado-plants-practical-care-avatar.png" width="80" height="80" alt="Colorado Plants &amp; Practical Care’s decorative berries, thorny branch and warning emblem"><p><strong><a href="{BOT}" target="_blank" rel="noopener">Colorado Plants &amp; Practical Care ↗</a></strong><br>The BoodleBox tutor that walks you through this website.</p></div>
...
<p><a class="field-open" href="{BOT}" target="_blank" rel="noopener">Open Colorado Plants &amp; Practical Care ↗</a></p>
<p>In BoodleBox, choose <strong>Start New Chat</strong>, or keep using your existing Colorado Plants &amp; Practical Care conversation. With the updated Fieldwork extension and both pages in Chrome split view, <strong>Put note in BoodleBox</strong> fills the empty chat draft. Review it and press <strong>Send</strong>.</p>
...
<noscript><p>To prepare a note here, enable JavaScript. You can also <a href="{BOT}">open Colorado Plants &amp; Practical Care</a> and paste a profile link and your observations directly into the chat.</p></noscript>
