---
{
  ...
  "warning": "Root suckers form persistent thickets",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Distinguish from sumacs and walnuts using leaflet bases and other features. Established root systems require a coordinated control plan.",
  "source_ids": [
    "CO-rules-2025",
    "N-ailanthus-altissima",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Tree of heaven: Root suckers form persistent thickets. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    {
      "id": "tree-of-heaven-list-meaning",
...
> **Root suckers form persistent thickets.** [Exposure help]({{BASE}}/safety/).
