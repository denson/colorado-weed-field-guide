---
{
  ...
  "scientific": "Centaurea solstitialis",
  "category": "invasive",
  "status": "Colorado noxious weed · List A — Eradicate",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Severe horse poisoning; sharp spines",
  "warning_tone": "danger",
  "aliases": [],
  "taxonomy_note": "A horse-specific poisoning hazard is established. Do not generalize controlled grazing by other livestock into unrestricted feeding advice.",
  "source_ids": [
    "CO-rules-2025",
    "N-centaurea-solstitialis",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Yellow starthistle: Severe horse poisoning; sharp spines. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Species-specific",
      "note": "",
      "id": "yellow-starthistle-5"
    },
    {
      "id": "yellow-starthistle-list-meaning",
...
> **Severe horse poisoning; sharp spines.** [Exposure help]({{BASE}}/safety/).
