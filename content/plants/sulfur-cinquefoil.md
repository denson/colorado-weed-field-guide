---
{
  ...
  "name": "Sulfur cinquefoil",
  "scientific": "Potentilla recta",
  "category": "invasive",
  "status": "Colorado noxious weed · List B — Stop the spread",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Persistent pasture and roadside weed",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Colorado has native cinquefoils. Confirm Potentilla recta before removing a yellow-flowered cinquefoil.",
  "source_ids": [
    "CO-rules-2025",
    "N-potentilla-recta",
    "S27",
  ...
  "description": "Sulfur cinquefoil: Persistent pasture and roadside weed. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "sulfur-cinquefoil-5"
    },
    {
      "id": "sulfur-cinquefoil-list-meaning",
...
> **Persistent pasture and roadside weed.** [Exposure help]({{BASE}}/safety/).
