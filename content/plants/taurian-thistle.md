...
{
  "id": "taurian-thistle",
  "name": "Taurian thistle",
  "scientific": "Onopordum tauricum",
  "category": "invasive",
  "status": "Colorado noxious weed · List B — Stop the spread",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Sharp spines; taxon listed as Scotch thistle",
  "warning_tone": "caution",
  "aliases": [
    "Scotch thistle",
    "bull cottonthistle"
  ],
  "taxonomy_note": "Onopordum acanthium has its own profile. Identification can be difficult; the reference study documents morphological variation among Italian populations, not Colorado impact severity.",
  "source_ids": [
    "CO-rules-2025",
    "P-tauricum",
    "S27",
  ...
  "description": "Taurian thistle: Sharp spines; taxon listed as Scotch thistle. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "note": "",
      "id": "taurian-thistle-5"
    },
    {
      "id": "taurian-thistle-list-meaning",
...
> **Sharp spines; taxon listed as Scotch thistle.** [Exposure help]({{BASE}}/safety/).
