---
{
  "id": "bulbous-bluegrass",
  "name": "Bulbous bluegrass",
  "scientific": "Poa bulbosa",
  "category": "invasive",
  "status": "Colorado noxious weed · List C",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Early-season grass spreads by bulbils",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "The USU page has an unrelated heading, but its scientific-name field and grass description identify Poa bulbosa. Only that species-specific body is used.",
  "source_ids": [
    "CO-rules-2025",
    "U-bulbous",
    "S27"
  ],
  "description": "Bulbous bluegrass: Early-season grass spreads by bulbils. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Early-season grass spreads by bulbils.** [Exposure help]({{BASE}}/safety/).
