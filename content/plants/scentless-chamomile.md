---
{
  "id": "scentless-chamomile",
  "name": "Scentless chamomile",
  "scientific": "Tripleurospermum inodorum",
  "category": "invasive",
  "status": "Colorado noxious weed · List B — Stop the spread",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Prolific seeds; reported livestock irritation",
  "warning_tone": "caution",
  "aliases": [
    "scentless mayweed",
    "Matricaria perforata"
  ],
  "taxonomy_note": "Not interchangeable with Roman chamomile, German chamomile or mayweed chamomile. Their poison and food-use records require exact name matching.",
  "source_ids": [
    "CO-rules-2025",
    "J-scentless-chamomile",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Scentless chamomile: Prolific seeds; reported livestock irritation. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Species-specific",
      "note": "",
      "id": "scentless-chamomile-5"
    },
    {
      "id": "scentless-chamomile-list-meaning",
...
> **Prolific seeds; reported livestock irritation.** [Exposure help]({{BASE}}/safety/).
