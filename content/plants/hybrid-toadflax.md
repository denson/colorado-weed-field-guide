...
{
  "id": "hybrid-toadflax",
  "name": "Yellow × Dalmatian toadflax hybrid",
  "scientific": "Linaria vulgaris × Linaria dalmatica",
  "category": "invasive",
  "status": "Colorado noxious weed · List B — Stop the spread",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Variable hybrid; persistent spreading roots",
  "warning_tone": "caution",
  "aliases": [
    "hybrid toadflax"
  ],
  "taxonomy_note": "Reference photos are identified hybrids in a USDA Forest Service manual. The third, flower-detail image is small because the original source is only 176 × 329 pixels; it has not been enlarged to imply more detail.",
  "source_ids": [
    "CO-rules-2025",
    "F-toadflaxes",
    "S27",
  ...
  "description": "Yellow × Dalmatian toadflax hybrid: Variable hybrid; persistent spreading roots. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Hybrid-group evidence; performance varies",
      "note": "",
      "id": "hybrid-toadflax-2"
    },
    {
      "label": "People",
      "sources": [],
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "hybrid-toadflax-5"
    },
    {
      "id": "hybrid-toadflax-list-meaning",
...
> **Variable hybrid; persistent spreading roots.** [Exposure help]({{BASE}}/safety/).
