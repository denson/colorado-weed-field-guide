---
{
  ...
  "warning": "Tough taproot and persistent lawn seedbank",
  "warning_tone": "caution",
  "aliases": [
    "cheeseweed",
    "buttonweed"
  ],
  "taxonomy_note": "Common names overlap with other Malva species. The reviewed account supports weed biology, not a declaration that all pet or livestock exposures are harmless.",
  "source_ids": [
    "CO-rules-2025",
    "N-malva-neglecta",
    "C-descriptions",
  ...
  "description": "Common mallow: Tough taproot and persistent lawn seedbank. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Tough taproot and persistent lawn seedbank.** [Exposure help]({{BASE}}/safety/).
