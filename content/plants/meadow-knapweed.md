...
{
  "id": "meadow-knapweed",
  "name": "Meadow knapweed",
  "scientific": "Centaurea × moncktonii",
  "category": "invasive",
  "status": "Colorado noxious weed · List A — Eradicate",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Outcompetes pasture and meadow plants",
  "warning_tone": "caution",
  "aliases": [
    "Centaurea x moncktonii",
    "Centaurea x gerstlaueri"
  ],
  "taxonomy_note": "A hybrid complex associated with C. jacea and C. nigra. Older meadow-knapweed names can represent different taxonomic concepts; records require checking.",
  "source_ids": [
    "CO-rules-2025",
    "WA-meadow-knapweed",
    "S27",
  ...
  "description": "Meadow knapweed: Outcompetes pasture and meadow plants. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "meadow-knapweed-5"
    },
    {
      "id": "meadow-knapweed-list-meaning",
...
> **Outcompetes pasture and meadow plants.** [Exposure help]({{BASE}}/safety/).
