---
{
  ...
  "warning": "Underground tubers sustain infestations",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "This listed sedge is described as native in the NC source; that broad range label is not a Colorado nativity assessment. It is distinct from purple nutsedge (Cyperus rotundus).",
  "source_ids": [
    "CO-rules-2025",
    "N-cyperus-esculentus",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Yellow nutsedge: Underground tubers sustain infestations. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "yellow-nutsedge-5"
    },
    {
      "id": "yellow-nutsedge-list-meaning",
...
> **Underground tubers sustain infestations.** [Exposure help]({{BASE}}/safety/).
