---
{
  "id": "red-valerian",
  "name": "Red valerian",
  "scientific": "Centranthus ruber",
  "category": "xeriscape",
  "status": "Introduced drought-tolerant ornamental",
  "status_sources": [
    "N-centranthus-ruber"
  ],
  "warning": "Self-seeds beyond garden beds",
  "warning_tone": "caution",
  "aliases": [
    "Jupiter's beard",
    "Valeriana rubra"
  ],
  "taxonomy_note": "The retrieved NC State source now treats Centranthus ruber as Valeriana rubra. The familiar garden name is retained for discovery; it is not Valeriana officinalis.",
  "source_ids": [
    "N-centranthus-ruber"
  ],
  "description": "Red valerian: Self-seeds beyond garden beds. Colorado identification, habitat and exposure evidence.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "note": "This guide does not assess ingestion safety or medicinal use.",
      "id": "red-valerian-3"
    },
    {
      "label": "Dogs & cats",
...
> **Self-seeds beyond garden beds.** Native status, garden use and noxious-weed class are separate from toxicity. [Exposure help]({{BASE}}/safety/).
