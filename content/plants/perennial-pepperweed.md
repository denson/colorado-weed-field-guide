---
{
  ...
  "warning": "Deep roots form persistent wetland colonies",
  ...
  "source_ids": [
    "CO-rules-2025",
    "J-perennial-pepperweed",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Perennial pepperweed: Deep roots form persistent wetland colonies. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "perennial-pepperweed-5"
    },
    {
      "id": "perennial-pepperweed-list-meaning",
...
> **Deep roots form persistent wetland colonies.** [Exposure help]({{BASE}}/safety/).
