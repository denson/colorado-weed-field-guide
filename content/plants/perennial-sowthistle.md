---
{
  "id": "perennial-sowthistle",
  "name": "Perennial sowthistle",
  ...
  "warning": "Persistent underground spread",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Annual sowthistles are separate species. A yellow flowerhead and milky sap are insufficient identification.",
  "source_ids": [
    "CO-rules-2025",
    "J-perennial-sowthistle",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Perennial sowthistle: Persistent underground spread. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "perennial-sowthistle-5"
    },
    {
      "id": "perennial-sowthistle-list-meaning",
...
> **Persistent underground spread.** [Exposure help]({{BASE}}/safety/).
