...
{
  "id": "hybrid-knapweed",
  "name": "Spotted × diffuse knapweed hybrid",
  "scientific": "Centaurea × psammogena",
  "category": "invasive",
  "status": "Colorado noxious weed · List B",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Hybrid identification needs expert review",
  "warning_tone": "caution",
  "aliases": [
    "hybrid knapweed"
  ],
  "taxonomy_note": "The source explains chromosome and subspecies differences in the parents and uncertainty in older identifications. The photographs come from a community research-grade Colorado observation, not genetic testing. No parent-species poisoning syndrome is assumed for the hybrid.",
  "source_ids": [
    "CO-rules-2025",
    "F-knapweed",
    "S27"
  ],
  "description": "Spotted × diffuse knapweed hybrid: Hybrid identification needs expert review. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Hybrid identification needs expert review.** [Exposure help]({{BASE}}/safety/).
