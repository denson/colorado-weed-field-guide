---
{
  ...
  "scientific": "Myriophyllum spicatum",
  "category": "invasive",
  "status": "Colorado noxious weed · List B — Stop the spread",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Fragments spread dense aquatic growth",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Native milfoils and hybrids can look similar. Confirm identification before management; a feathery leaf is not enough.",
  "source_ids": [
    "CO-rules-2025",
    "N-myriophyllum-spicatum",
    "S27",
    "Fremont-list-definitions"
  ],
  "description": "Eurasian watermilfoil: Fragments spread dense aquatic growth. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "eurasian-watermilfoil-5"
    },
    {
      "id": "eurasian-watermilfoil-list-meaning",
...
> **Fragments spread dense aquatic growth.** [Exposure help]({{BASE}}/safety/).
