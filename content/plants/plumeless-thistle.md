---
{
  "id": "plumeless-thistle",
  "name": "Plumeless thistle",
  "scientific": "Carduus acanthoides",
  "category": "invasive",
  "status": "Colorado noxious weed · List B",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Sharp spines; pasture competition",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Distinguish introduced Carduus from Colorado’s native thistles before removal.",
  "source_ids": [
    "CO-rules-2025",
    "J-plumeless-thistle",
    "S27"
  ],
  "description": "Plumeless thistle: Sharp spines; pasture competition. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Sharp spines; pasture competition.** [Exposure help]({{BASE}}/safety/).
