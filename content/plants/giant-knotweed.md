---
{
  "id": "giant-knotweed",
  "name": "Giant knotweed",
  "scientific": "Reynoutria sachalinensis",
  "category": "invasive",
  "status": "Colorado noxious weed · List A",
  "status_sources": [
    "CO-rules-2025"
  ],
  "warning": "Very persistent riparian colonies",
  ...
  "taxonomy_note": "The state rule uses Fallopia sachalinense. Giant, Japanese and Bohemian knotweeds overlap in appearance; confirm identity beyond plant height.",
  "source_ids": [
    "CO-rules-2025",
    "WA-giant-knotweed",
    "S27"
  ],
  "description": "Giant knotweed: Very persistent riparian colonies. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Very persistent riparian colonies.** [Exposure help]({{BASE}}/safety/).
