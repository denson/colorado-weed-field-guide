---
{
  ...
  "warning": "Thorns; riparian habitat concern",
  ...
  "description": "Russian olive: Thorns; riparian habitat concern. Colorado identification, habitat and exposure evidence.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Thorns; riparian habitat concern.** Native status, garden use and noxious-weed class are separate from toxicity. [Exposure help]({{BASE}}/safety/).
