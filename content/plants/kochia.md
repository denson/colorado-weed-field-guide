---
{
  ...
  "warning": "Tumbling seed spread; livestock poisoning risk",
  "warning_tone": "danger",
  "aliases": [
    "Kochia scoparia",
    "burning bush",
  ...
  "taxonomy_note": "Bassia scoparia is also published as Kochia scoparia. It is distinct from Russian thistle and from the woody ornamental Euonymus alatus, also called burning bush.",
  "source_ids": [
    "C-tumbleweeds",
    "CO-rules-2025",
    "S27",
  ...
  "description": "Kochia: Tumbling seed spread; livestock poisoning risk. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
...
> **Tumbling seed spread; livestock poisoning risk.** [Exposure help]({{BASE}}/safety/).
