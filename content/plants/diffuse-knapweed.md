---
{
  ...
  "warning": "Skin irritation; tumbling seed spread",
  "warning_tone": "caution",
  "aliases": [],
  "taxonomy_note": "Spotted knapweed and spotted × diffuse hybrids require separate identification. Russian-knapweed horse poisoning must not be transferred merely because the common names overlap.",
  "source_ids": [
    "CO-rules-2025",
    "J-diffuse-knapweed",
    "S27"
  ],
  "description": "Diffuse knapweed: Skin irritation; tumbling seed spread. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Physical-risk inference; chemical-toxicity gap",
      "note": "",
      "id": "diffuse-knapweed-4"
    },
    {
      "label": "Other animals",
      "sources": [],
...
> **Skin irritation; tumbling seed spread.** [Exposure help]({{BASE}}/safety/).
