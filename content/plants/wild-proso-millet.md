---
{
  "id": "wild-proso-millet",
  "name": "Wild proso millet",
  ...
  "warning": "Seed contamination and crop competition",
  "warning_tone": "caution",
  "aliases": [
    "proso millet",
    "broomcorn millet"
  ],
  "taxonomy_note": "Cultivated proso and wild proso belong to the same species. These species-reference photographs include cultivated settings and do not demonstrate a wild, shattering or herbicide-resistant biotype. Seed and field-history assessment is needed.",
  "source_ids": [
    "CO-rules-2025",
    "K-wild-proso",
    "S27",
  ...
  "description": "Wild proso millet: Seed contamination and crop competition. Identification and evidence for Colorado readers.",
  "claim_evidence": [
    {
      "label": "Recognize",
      "sources": [
    ...
    },
    {
      ...
      "scope": "Review limitation",
      "note": "",
      "id": "wild-proso-millet-5"
    },
    {
      "id": "wild-proso-millet-list-meaning",
...
> **Seed contamination and crop competition.** [Exposure help]({{BASE}}/safety/).
